...
# therefore the initial items ("bpd_absExtra_20.t1" and "bpd_absExtra_20.t1") are kept for the scale.
...
scales_continous_group <- c("BPD_screen", "CESD.t1", "PANAS_POS.t1", "PANAS_NEG.t1", "PANAS.t1", 
            "IPIP_openness", "IPIP_conscientiousness", "IPIP_extraversion", "IPIP_agreeableness", "IPIP_neuroticism", 
            "BPD", "BPD_stress", "BPD_alien", "BPD_control", "BPD_aggression", "BPD_abs1", "EXTR", "GEN_IMPR.t1", "Group_affect")
