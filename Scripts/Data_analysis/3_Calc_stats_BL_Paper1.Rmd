...
plot_group_diff_panas <- ggarrange(
  plot_manipulation(panas_scale=data_final_bl_scales$PANAS_NEG.t1, title="PANAS Negative"), 
  plot_manipulation(panas_scale=data_final_bl_scales$PANAS_POS.t1, title="PANAS Positive"),
          hjust=0.8, vjust=0.5,
          common.legend = T)
...
plot_panas_neg <- plot_bpd_y(y="PANAS_NEG.t1", y_title="Affect \n(PANAS / Negative)", breaks=seq(-60, 60, 10))

# plot PANAS / Negative scale
plot_panas_pos <- plot_bpd_y(y="PANAS_POS.t1", y_title="Affect \n(PANAS / Positive)", breaks=seq(-60, 60, 10))
...
# save plot
ggsave("fig1_distribution_mediators.jpg", plot=plot_bpd_y, 
