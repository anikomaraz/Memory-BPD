...
my_access_key = "f19969715c051a462fdd16022154736b"
my_access_key2 = "6ddec55b4e488f4e3dac2ea3ca5b39c8"
...
data_ip <- data_ip[lapply(data_ip$ip_address.sc, str_length) > 0L,]

# get the country code for each ip address
data_ip$ip_country_code <- sapply(data_ip$ip_address.sc, get_geo_ip)
data_ip$ip_country_code_correct <- 
