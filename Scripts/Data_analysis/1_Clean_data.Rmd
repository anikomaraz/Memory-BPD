...
get_bpdMemo_raw_data(my_version="180726") # results in data_raw AND  data_t1time
get_bpdMemo_raw_data_mturk(my_version="180727") # returns data_raw_mturk AND  data_t1time_mturk


# merge facebook and mturk data
#data_raw_full <- bind_rows(data_raw, data_raw_mturk)
...
data_time <- data_time[lengths(data_time$session) > 0L,]
