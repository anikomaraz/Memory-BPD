...
if (online) {
  ...
  data <- data.frame(
    as.numeric(part1_MTurk$ipip_extra_1),
    as.numeric(part1_MTurk$ipip_agree_1),
    as.numeric(part1_MTurk$ipip_consc_1),
    as.numeric(part1_MTurk$ipip_neuro_1),
    as.numeric(part1_MTurk$ipip_open_1),
    as.numeric(part1_MTurk$ipip_extra_2R),
    as.numeric(part1_MTurk$ipip_agree_2R),
    as.numeric(part1_MTurk$ipip_consc_2R),
    as.numeric(part1_MTurk$ipip_neuro_2R),
    as.numeric(part1_MTurk$ipip_open_2R),
    as.numeric(part1_MTurk$ipip_extra_3),
    as.numeric(part1_MTurk$ipip_agree_3),
    as.numeric(part1_MTurk$ipip_consc_3),
    as.numeric(part1_MTurk$ipip_neuro_3),
    as.numeric(part1_MTurk$ipip_open_3R),
    as.numeric(part1_MTurk$ipip_extra_4R),
    as.numeric(part1_MTurk$ipip_agree_4R),
    as.numeric(part1_MTurk$ipip_consc_4R),
    as.numeric(part1_MTurk$ipip_neuro_4R),
    as.numeric(part1_MTurk$ipip_open_4R) )

    } else {
      data <- read.csv2("../../Data/Raw_data/part1_MTurk_180726.csv", sep=";")
