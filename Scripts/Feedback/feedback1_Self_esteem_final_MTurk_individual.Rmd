...
data_SE <- read.csv2("../../Data/Raw_data/part4_MTurk_180820.csv", sep=",")
# select MTurkers who inquire by session
data_SE <- data_SE[data_SE$session == "pCawP_aGjxTJHZopQWvm8cLdU_CtSPpivCOx0gmJNa7dJn5lLCJ7FS6XwFTFz9uS", ]
